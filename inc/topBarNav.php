...
<nav class="navbar navbar-expand-lg navbar-dark bg-gradient-teal">
            <div class="container px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link text-white" href="./?p=request_quote">Send Request</a></li>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <a class="font-weight-bolder text-light mx-2 text-decoration-none" href="./residents">Residents Panel</a>
                    </div>
                </div>
            </div>
        </nav>
